			...
			<div class="jumbotron">
				...
				<li><label>Môn học</label><select
					class="form-control" onchange="location = this.options[this.selectedIndex].value;">
						...
						<option value="Dangkiwindows-win.jsp">Lập trình window</option>
						</select></li>
						<li><label>Lớp học</label><select
					class="form-control" >
						<option>Thu 3-5 (19h00-21h00) KG: 1 thang 10</option>
						<option>Thu 2-4 (19h00-21h00) KG: 1 thang 10</option>
						</select></li>
			</ul>
